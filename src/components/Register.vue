<template>
  ...
  <div>
    ...
    <input type="email" placeholder="Email" class="mt-2 h-12 w-full rounded-md bg-gray-100 px-3" />
  </div>
  <div>
  ...
  <div class="grid gap-3 lg:grid-cols-2">
    ...
    <div>
      ...
      <input type="text" placeholder="+62 853 5445 0543" class="mt-2 h-12 w-full rounded-md bg-gray-100 px-3" />
    </div>
  </div>

  <div class="checkbox">
    <input type="checkbox" id="chekcbox1" checked="" />
    <label for="checkbox1">I agree to the <a href="/login" target="_blank" class="text-blue-600"> Terms and Conditions </a> </label>
  </div>

  <div>
    <button type="button" class="mt-5 w-full rounded-md bg-blue-600 p-2 text-center font-semibold text-white">Create account</button>
  </div>
</form>
