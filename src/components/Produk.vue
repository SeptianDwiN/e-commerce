...
<div>
  <!--Produk-->
    <p class="text-2xl m-10 text-center" ><a href="#"><u>All Produk...</u></a></p>
<div class="grid grid-cols-4 gap-10 m-14">
  ...
  <div class="mt-4 px-5 pb-5">
    ...
    <div class="mt-2 mb-5 flex items-center justify-between">
      <p>
        <span class="text-3xl font-bold text-slate-900">Rp.449.000</span>
        <span class="text-sm text-slate-900 line-through">Rp.699.000</span>
      </p>
    </div>
