    ...
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        ...
        <div class="flex w-full flex-col px-4 py-4">
          ...
          <p class="text-lg font-bold">Rp.499.000</p>
        </div>
      </div>
    ...
    <div class="">
      ...
      <div class="flex flex-col sm:flex-row">
        <div class="relative flex-shrink-0 sm:w-7/12">
          ...
          <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
            <img class="h-4 w-4 object-contain" src="../assets/img/indo.png" alt="" />
          </div>
        </div>
      ...
      <div class="mt-6 border-t border-b py-2">
        <div class="flex items-center justify-between">
          ...
          <p class="font-semibold text-gray-900">Rp.499.000</p>
        </div>
        <div class="flex items-center justify-between">
      ...
      <div class="mt-6 flex items-center justify-between">
        ...
        <p class="text-2xl font-semibold text-gray-900">Rp507.000</p>
      </div>
    </div>
