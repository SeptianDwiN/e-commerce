  ...
  <div class="px-4 pt-8">
    ...
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="../assets/img/compas3.jpg" alt="" />
        <div class="flex w-full flex-col px-4 py-4">
          <span class="font-semibold">{{cart.name}}</span>
          <span class="float-right text-gray-400">Jumlah: {{ cart.qty }}</span>
          <p class="text-lg font-bold">{{cart.regular_price}}</p>
        </div>
      </div>
    </div>
    </div>
    ...
    <form class="mt-5 grid gap-6">
      ...
      <div class="relative">
        <input class="peer hidden" v-model="paymentType" value="cash_on_delivery" id="radio_2" type="radio" name="radio" checked />
        <span class="peer-checked:border-gray-700 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
        <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_2">
          <img class="w-14 object-contain" src="https://cdn-icons-png.flaticon.com/512/218/218390.png" alt="" />
          <div class="ml-6">
            <span class="mt-2 font-semibold">Payment Wallet</span>
          </div>
        </label>
      </div>
    </form>
    ...
    <form class="mt-5  gap-6 grid grid-cols-2">
      <div class="relative">
    ...
    <div class="">
      ...
      <div class="mt-6 border-t border-b py-2">
        ...
        <!-- <div class="flex items-center justify-between">
          ...
          <p class="font-semibold text-gray-900">Rp.8.000</p>
        </div> -->
      </div>
