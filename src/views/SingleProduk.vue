          ...
          <div v-if="produk">
              <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
                      ...
                      <div class="lg:flex lg:items-start">
                          <div class="lg:order-2 lg:ml-5">
                              <div class="max-w-xl overflow-hidden rounded-lg">
                                  <img class="h-full w-full max-w-full object-cover" src="../assets/img/compas3.jpg" alt="" />
                              </div>
                          </div>
                          ...
                          <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                              <div class="flex flex-row items-start lg:flex-col">
                                  <button type="button"
                                      ...
                                      <img class="h-full w-full object-cover" src="../assets/img/compas3.jpg" alt="" />
                                  </button>
                                  <button type="button"
                  ...
                  <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                      <h1 class="sm: text-2xl font-bold text-gray-900 sm:text-3xl"> {{ produk.name }}</h1>
                ...
                <svg class="block h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                  ...
                  <div class="lg:col-span-3">
                      ...
                      <div class="mt-8 flow-root sm:mt-12">
                          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. In quia doloribus vel nam fugiat cumque? Blanditiis officia et dolores consectetur commodi consequatur tenetur! Deleniti laboriosam eligendi eaque doloribus magni doloremque?</p>
                      </div>
                  </div>
              </div>
          </div>
