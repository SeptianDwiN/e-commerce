...
<div class="flex min-h-screen w-screen" >
        ...
        <div class="flex h-full w-full space-x-3 overflow-hidden md:justify-end">
          ...
          <div class="hidden w-56 items-center space-y-3 lg:flex">
            <div class="overflow-hidden rounded-xl bg-yellow-400">
              <img class="h-full w-full object-cover" src="../assets/img/compas1.jpg" alt="" />
            </div>
          </div>
          <div class="w-full flex-col space-y-3 rounded-xl py-4 lg:flex lg:w-80">
            <div class="h-40 overflow-hidden rounded-xl bg-green-600/60">
              <img class="mx-auto h-full w-full object-cover" src="../assets/img/compas2.jpg" alt="" />
            </div>
            <div class="h-40 overflow-hidden rounded-xl bg-pink-600/60">
              <img class="mx-auto h-full w-full object-cover" src="../assets//img/compas3.jpg" alt="" />
            </div>
            <div class="h-40 overflow-hidden rounded-xl bg-blue-600/60">
              <img class="mx-auto h-full w-full object-cover" src="../assets//img/compas4.jpg" alt="" />
            </div>
          </div>
        </div>
        <!-- /Right Column -->
    ...
    <br>
  <h1 class="mb-4 text-3xl font-black sm:text-5xl xl:text-5xl" ><center>Produk</center></h1>
<div  class="grid grid-cols-4 gap-16 m-14" >
  <!--Produk-->
  
  
<div  v-for="produk in getProduk.data.slice(0,8)"  >
    <div class="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
  <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="/singleproduk">
    <img class="object-cover" src="../assets/img/compas3.jpg" alt="product image" />
    <span class="absolute top-0 left-0 m-2 rounded-full bg-black px-2 text-center text-sm font-medium text-white">39% OFF</span>
  </a>
  <div class=" mt-4 px-5 pb-5">
    <a href="/singleproduk">
      <h5 class="text-xl tracking-tight text-slate-900">{{ produk.name }}</h5>
    </a>
    <div class="mt-2 mb-5 flex items-center justify-between">
      <p>
        <span class="text-3xl font-bold text-slate-900">{{ produk.base_price }}</span>
       
      </p>
    </div>
    <a href="/cart" class="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
